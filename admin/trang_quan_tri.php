              ...
              <div class="row tile_count">
               ...
               <!-- tong so san pham -->
                <?php
                 ...
                 $ketnoi = mysqli_connect($host, $dbusername, $dbpassword, $dbname);
                 $sql = "
                 SELECT count(id) as tongsanpham
                 FROM tbl_san_pham";
               $dulieu = mysqli_query($ketnoi, $sql);
               while ($row = mysqli_fetch_array($dulieu)) {
                ;?>
                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                  <span class="count_top"><i class="fa fa-user"></i> Tổng số homestay</span>
                  <div class="count green"><?php echo $row['tongsanpham'];?></div>
               ...
               ;?>
                ...
                <?php
                 ...
                 $ketnoi = mysqli_connect($host, $dbusername, $dbpassword, $dbname);
                 $sql = "
                 SELECT count(id) as tongdonhang
                 FROM tbl_giao_dich";
               $dulieu = mysqli_query($ketnoi, $sql);
               while ($row = mysqli_fetch_array($dulieu)) {
                ;?>
                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                  <span class="count_top"><i class="fa fa-user"></i>Tổng số phòng đặt qua wesite</span>
                  <div class="count"><?php echo $row['tongdonhang'];?></div>
                  <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>12% </i> From last Week</span>
                </div>
                <?php
               }

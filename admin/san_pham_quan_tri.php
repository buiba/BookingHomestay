                   ...
                   <table class="table">
                      ...
                      ;?>
                        ...
                        <tr>
                          ...
                          <td><a href="san_pham_sua.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a></td>
                          <td><a href="san_pham_xoa.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                        </tr>
                      <?php
                      }
                      ;?>

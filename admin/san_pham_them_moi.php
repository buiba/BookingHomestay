                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        ;?>
                            <option value="<?php echo $row["loai_san_pham_id"];?>"><?php echo $row["ten_loai_san_pham"];?></option>
                        <?php
                        }
                        ;?>
                        </select>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        while ($row = mysqli_fetch_array($dulieu)) {
                        ;?>
                            <option value="<?php echo $row["trang_thai_id"];?>"><?php echo $row["ten_trang_thai"];?></option>
                        <?php
                        }
                        ;?>
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                    <input name="txtGiaTien" type="text" class="form-control">
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                    <input name="txtGiaKhuyenMai" type="text" class="form-control">
                    </div>
                  </div>  
                  <be><br><br>
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        //Bước 2: Hiển thị các dữ liệu trong bảng tblLienHe ra đâyß
                        $sql = "
                          SELECT * 
                          FROM tbl_bo_nho";
                        $dulieu = mysqli_query($ketnoi, $sql);
                        while ($row = mysqli_fetch_array($dulieu)) {
                        ;?>
                            <option value="<?php echo $row["bo_nho_id"];?>"><?php echo $row["ten_bo_nho"];?></option>
                        <?php
                        }
                        ;?>
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        ...
                        while ($row = mysqli_fetch_array($dulieu)) {
                        ;?>
                            <option value="<?php echo $row["mau_sac_id"];?>"><?php echo $row["ten_mau_sac"];?></option>
                        <?php
                        }
                        ;?>
                        </select>

            <div class="navbar nav_title" style="border: 0;"><a href="trang_quan_tri.php" class="site_title"><i class="fa fa-paw"></i> <span>BABV SITE!</span></a></div>
            ...
            <div class="profile clearfix">
              ...
              if(isset($_SESSION['tai_khoan']))
              {
                ...
                echo"<a href='../dang_ki.php'>Đăng kí</a>";
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Quản trị Homestay <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="san_pham_them_moi.php">Thêm Homestay mới</a></li>
                      <li><a href="san_pham_quan_tri.php">Quản trị Homestay</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a href="quan_tri_don_hang.php"><i class="fa fa-bar-chart-o"></i> Quản trị Đặt Phòng</a></li>
                  <li><a href="email_quan_tri.php"><i class="fa fa-bar-chart-o"></i> Quản trị Email</a></li>
                  <li><a href="cong_viec_them_moi.php"><i class="fa fa-bar-chart-o"></i>Thêm Nhiệm Vụ Mới</a></li>
              </div>
            </div>
            <!-- /sidebar menu -->

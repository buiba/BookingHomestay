				   			...
				   			<div class="col-md-6 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1>Liên hệ với chúng tôi</h1>
										<h2>Chúng tôi luôn lắng nghe và tiếp thu những ý kiến từ khách hàng và hoàn thiện ngày một tốt hơn dịch vụ của mình <a href="http://qbootstrap.com/" target="_blank">Bookingvietnam.tk</a></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
